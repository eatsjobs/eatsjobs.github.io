...
export default function (eleventyConfig) {
  ...
  // Filters only (dateToRfc3339, htmlToAbsoluteUrls, ...) - feed.njk is written
  // by hand rather than generated by this plugin's feedPlugin, which hardcodes
  // post.data.title and would repeat the site name in every entry title.
  ...
  // sitemap.xml is generated from collections by sitemap.njk, not copied.
